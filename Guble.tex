...
\censor{Your introduction goes here! Simply start writing your document and use the Recompile button to view the updated PDF preview. Examples of commonly used commands and features are listed below, to help you get started.}
...
\begin{figure}
\centering
\includegraphics[width=0.25\linewidth]{\censor{assets/frog.png}}
